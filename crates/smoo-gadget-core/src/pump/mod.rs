...
/// Cloneable handle for submitting work to the background I/O pump.
...
async fn bulk_out_worker(
    ...
    loop {
        ...
        // The guard drops before complete_io, but ublk will not reuse this
        // (queue_id, tag) slot until the completion is enqueued below.
